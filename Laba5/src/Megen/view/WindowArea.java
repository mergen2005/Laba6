...
public class WindowArea {
    ...
    public WindowArea(JFrame jFrame, TheTableModel myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица областей", true);
    ...
    public void init() {
        ...
        this.jTable = new JTable();
        this.jTable.setModel(myTableModel); // Устанавливаем модель данных
