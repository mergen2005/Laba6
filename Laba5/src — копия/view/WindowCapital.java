...
import Megen.data.TheTableModel;
...
public class WindowCapital {
    ...
    public WindowCapital(JFrame jFrame, TheTableModel myTableModel) {
        this.myTableModel = myTableModel;
        this.dialog = new JDialog(jFrame, "Таблица столиц", true);
        ...
        button_delete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    show_error("Пожалуйста, выделите строку для удаления.");
                }
            }
        });
